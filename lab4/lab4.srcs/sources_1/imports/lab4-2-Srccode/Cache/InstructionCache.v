...
module InstructionCache(
    ...
    initial begin
        ...
        inst_cache[       6] = 32'h024000ef;//jal    ra  , QuickSort  
        inst_cache[       7] = 32'h00068293;
        inst_cache[       8] = 32'h00050313;
        inst_cache[       9] = 32'h00229293;
        inst_cache[      10] = 32'h00231313;//slli   t1, t1, 2
        inst_cache[      11] = 32'h00032383;//lw     t2, (t1)
        inst_cache[      12] = 32'h00430313;
        inst_cache[      13] = 32'hfe534ce3;
        inst_cache[      14] = 32'h0000006f;//jal   zero, infinity_loop
        inst_cache[      15] = 32'h0cc5da63;//bge    a1, a2, QuickSortReturn 
        inst_cache[      16] = 32'h0005e333;
        inst_cache[      17] = 32'h000663b3;
        inst_cache[      18] = 32'h006502b3;
        inst_cache[      19] = 32'h0002a283;
        inst_cache[      20] = 32'h04735263;// bge    t1, t2, PartationEnd 
        inst_cache[      21] = 32'h00750e33;
        inst_cache[      22] = 32'h000e2e03;
        inst_cache[      23] = 32'h005e4663;
        inst_cache[      24] = 32'hffc38393;
        inst_cache[      25] = 32'hfedff06f;//jal    zero, PartationFirstStart 
        inst_cache[      26] = 32'h00650eb3;//add    t4  , a0, t1
        inst_cache[      27] = 32'h01cea023;
        inst_cache[      28] = 32'h02735263;// bge    t1, t2, PartationEnd  
        inst_cache[      29] = 32'h00650e33;
        inst_cache[      30] = 32'h000e2e03;
        inst_cache[      31] = 32'h01c2c663;//blt    t0, t3, PartationSecondEnd
        inst_cache[      32] = 32'h00430313;
        inst_cache[      33] = 32'hfedff06f;//jal    zero, PartationSecondStart
        inst_cache[      34] = 32'h00750eb3;
        inst_cache[      35] = 32'h01cea023;
        inst_cache[      36] = 32'hfc7340e3;//blt    t1, t2, PartationStart  
